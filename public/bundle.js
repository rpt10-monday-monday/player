...
_reactDom2.default.render(_react2.default.createElement(_player2.default, null), document.getElementById('player'));
...
*/
var aa=__webpack_require__(4),n=__webpack_require__(3),ba=__webpack_require__(6);function ca(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
